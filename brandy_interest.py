...
class Interest:
    ...
    def data_merge(self, merge=True):
        ...
        start = time.time()
        data_lv1, self.fbids_lv1=self.get_interest('training_data/SOURCE_TRAINING_CLEAN_LV1.csv')
        data_lv2, self.fbids_lv2=self.get_interest('training_data/SOURCE_TRAINING_CLEAN_LV2.csv')
        data_lv3, self.fbids_lv3=self.get_interest('training_data/SOURCE_TRAINING_CLEAN_LV3.csv')
        data_lv4, self.fbids_lv4=self.get_interest('training_data/SOURCE_TRAINING_CLEAN_LV4.csv')
        data_lv5, self.fbids_lv5=self.get_interest('training_data/SOURCE_TRAINING_CLEAN_LV5.csv')
